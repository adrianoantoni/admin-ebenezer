...
export const MENU_ITEMS = [
  { id: 'dashboard', label: 'Dashboard', icon: <LayoutDashboard size={20} />, roles: [UserRole.SUPER_ADMIN, UserRole.PASTOR, UserRole.SECRETARY, UserRole.USER] },
  { id: 'members', label: 'Membros', icon: <Users size={20} />, roles: [UserRole.SUPER_ADMIN, UserRole.PASTOR, UserRole.SECRETARY, UserRole.TREASURER] },
  ...
  { id: 'marriages', label: 'Casamentos', icon: <Heart size={20} />, roles: [UserRole.SUPER_ADMIN, UserRole.PASTOR, UserRole.SECRETARY, UserRole.TREASURER] },
  { id: 'finance', label: 'Financeiro', icon: <DollarSign size={20} />, roles: [UserRole.SUPER_ADMIN, UserRole.PASTOR, UserRole.TREASURER] },
  { id: 'school', label: 'Escola Dominical', icon: <GraduationCap size={20} />, roles: [UserRole.SUPER_ADMIN, UserRole.PASTOR, UserRole.SECRETARY, UserRole.TREASURER] },
  ...
  { id: 'calendar', label: 'Calendário', icon: <Calendar size={20} />, roles: [UserRole.SUPER_ADMIN, UserRole.PASTOR, UserRole.SECRETARY, UserRole.USER, UserRole.TREASURER] },
  { id: 'reports', label: 'Relatórios', icon: <BarChart3 size={20} />, roles: [UserRole.SUPER_ADMIN, UserRole.PASTOR] },
