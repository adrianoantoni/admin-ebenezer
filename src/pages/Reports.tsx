...
const Reports: React.FC = () => {
  ...
  const handleAiAnalysis = async () => {
    ...
    try {
      ...
      const prompt = `
        Aja como um Consultor Analítico Sênior para a {state.churchSettings?.nomeIgreja || 'Eclesia Master'}. 
  ...
  const handleDownloadExpensesPDF = async () => {
    ...
    try {
      ...
      pdf.setProperties({
        ...
        author: `${state.churchSettings?.nomeIgreja || 'Eclesia Master'} System`
      });
      pdf.setFontSize(18);
      ...
      <div id="report-content" className="space-y-8 animate-in fade-in duration-500 bg-white p-8 md:p-12 rounded-[3.5rem] print:shadow-none shadow-sm border border-gray-100">
        ...
        <div className="flex items-start justify-between mb-12 border-b-2 border-blue-900 pb-8">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h1 className="text-3xl font-black text-blue-900 uppercase tracking-tight">{state.churchSettings?.nomeIgreja || 'Eclesia Master'}</h1>
      ...
      {createPortal(
        <div id="full-report-print-view" className="hidden print:block bg-white p-0 text-gray-900 font-sans w-full">
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <h1 className="text-4xl font-black text-blue-900 uppercase tracking-tight">{state.churchSettings?.nomeIgreja || 'Eclesia Master'}</h1>
        ...
        <div className="mt-20 pt-10 border-t-2 border-gray-200 flex justify-between italic text-gray-400 text-xs">
          <p>Documento gerado eletronicamente pelo sistema {state.churchSettings?.nomeIgreja || 'Eclesia Master'}.</p>
